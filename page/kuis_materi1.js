...
function hasil(){
  onValue(ref(db,  `UserMahasiswa/${nim}/kuis/kuis-1`), (snapshot) => {
    const data = snapshot.val();
    if(data[`skor`] == 0){
      mulaiKuis.innerHTML += `
        <div class="card-body">
            <div class="text-center">
                <h2>Kuis Materi 1 : Pengalanan Bahasa Pemrograman Java </h3>
            </div>
            <hr>
            <div class="card">
      ...
      btnMulaiKuis.addEventListener("click", ()=>{
        update(ref(db, `UserMahasiswa/${nim}/kuis`), {
          ...
          location.href = "/page/kuis_materi1.html";
        });
      });

    }else{
      mulaiKuis.innerHTML += `
      <div class="card-body" style="height: 10%; overflow: none;" >
                    <h3 class="text-center">Hasil Kuis Materi 1 - Pengantar Java</h3>
                    <hr>
                ...
                <div class="d-md-flex justify-content-md-center text-decoration-none tombol-hasil-kuis">
                           ...
                           <button href="/page/kuis_materi1.html" class="btn btn-danger mx-2 mb-4" id="ulangi-kuis" >Ulang Kuis <i class="fas fa-undo-alt"></i></button>
                         </div>
                       </div>`
                      ...
                      ulangiKuis.addEventListener("click", () => {
                        update(ref(db, `UserMahasiswa/${nim}/kuis`), {
                          ...
                          location.href = "/page/petunjukkuis_materi1.html";
                        });
                      });
                    }
                  });
...
//   else{
    ...
    onValue(ref(db, "Soal/Soal Kuis materi 1"), (snapshot) => {
        // const pilihanGanda = document.querySelector(".pilihan-ganda");
        const data = snapshot.val();
        ...
        for (let i = 1; i <= 10;  i++) {
            ...
            <div class="div-soal ${tampilanSoal} px-2">
              <div class="lg-lh mx-2">${data[`Soal Kuis materi 1-${i}`]["Teks Soal"]}</div>
        ...
        for (let i = 1; i <= 10; i++) {
          ...
          for (let j = 0; j < labelPilihanGanda.length; j++) {
            labelPilihanGanda[j].addEventListener("click", () => {
              ...
              set(ref(db, `UserMahasiswa/${nim}/kuis/kuis-1/nomor/${i}`), {
                jawaban: pilihan, 
              });
            });
          }
        ...
        onValue(ref(db, `UserMahasiswa/${nim}/kuis/kuis-1/nomor/`), (snapshot) => {
            ...
            if (sudahDijawab.length < 10) {
              ...
              .then((willDelete) => {
                if (willDelete) {
                  ...
                  update(ref(db, `UserMahasiswa/${nim}/kuis/kuis-1`), {
                    selesai: true,
                    skor: benar * 10,
                    tanggal: dbtanggal,
                    waktu: dbwaktu
