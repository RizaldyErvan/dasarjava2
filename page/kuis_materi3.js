...
function hasil(){
  onValue(ref(db,  `UserMahasiswa/${nim}/kuis/kuis-3`), (snapshot) => {
    const data = snapshot.val();
    if(data[`skor`] == 0){
      mulaiKuis.innerHTML += `
        <div class="card-body">
            <div class="text-center">
                <h2>Kuis Materi 3 : Tipe Data Java </h3>
            </div>
            <hr>
            <div class="card">
            ...
            <div class="row my-2">
                <div class="col-md-6 align-self-center mt-2">
                    <a href="/page/materi3_sub1.html" class="btn-md btn-block btn_sebelumnya1">Kembali Ke materi</a>
                </div>
                <div class="col-md-6">
                    <a href="/page/kuis_materi3.html">
      ...
      btnMulaiKuis.addEventListener("click", ()=>{
        update(ref(db, `UserMahasiswa/${nim}/kuis`), {
          ...
          location.href = "/page/kuis_materi3.html";
        });
      });
      ...
      mulaiKuis.innerHTML += `
      <div class="card-body">
                    <h3 class="text-center">Hasil Kuis Materi 3</h3>
                    <hr>
                ...
                <div class="d-md-flex justify-content-md-center text-decoration-none tombol-hasil-kuis">
                           <a href="/page/materi2_sub1.html" class="btn btn-secondary mx-2 mb-4" tabindex="-1" role="button">Ulang Materi <i class="fas fa-undo-alt"></i></a>
                      ...
                      ulangiKuis.addEventListener("click", () => {
                        update(ref(db, `UserMahasiswa/${nim}/kuis`), {
                          ...
                          location.href = "/page/petunjukkuis_materi3.html";
                        });
                      });
                    }
                  });
...
//   else{
    ...
    onValue(ref(db, "Soal/Soal Kuis materi 3"), (snapshot) => {
        // const pilihanGanda = document.querySelector(".pilihan-ganda");
        const data = snapshot.val();
        ...
        for (let i = 1; i <= 10;  i++) {
            ...
            <div class="div-soal ${tampilanSoal} px-2">
              <div class="lg-lh text-break mx-2">${data[`Soal Kuis materi 3-${i}`]["Teks Soal"]}</div>
        ...
        for (let i = 1; i <= 10; i++) {
          ...
          for (let j = 0; j < labelPilihanGanda.length; j++) {
            labelPilihanGanda[j].addEventListener("click", () => {
              ...
              set(ref(db, `UserMahasiswa/${nim}/kuis/kuis-3/nomor/${i}`), {
                jawaban: pilihan, 
              });
            });
          }
        ...
        onValue(ref(db, `UserMahasiswa/${nim}/kuis/kuis-3/nomor/`), (snapshot) => {
            ...
            if (sudahDijawab.length < 10) {
              ...
              .then((willDelete) => {
                if (willDelete) {
                  ...
                  update(ref(db, `UserMahasiswa/${nim}/kuis/kuis-3`), {
                    selesai: true,
                    skor: benar * 10,
                    tanggal: dbtanggal,
                    waktu: dbwaktu
